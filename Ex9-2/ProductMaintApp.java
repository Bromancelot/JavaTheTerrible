/*
    CHC-26APR2019
        Added (Updated) the Update method of the application.
        Made the Update method ACTUALLY update description or price depending
        on user's input.
*/
...
public class ProductMaintApp
{
	...
	String input = Validator.getString(
           sc,"Would you like the description or price? (d/p): ");
        
	if (input.equalsIgnoreCase("d"))
            {
                String description = Validator.getString(
                    sc,"What would you like the description to be?: ");
                p.setDescription(description);
	    }
	if (input.equalsIgnoreCase("p"))
	    {
	        double price = Validator.getDouble(
                    sc, "What would you like the price to be?: ");
	        p.setPrice(price);
	    }
        
	productDAO.updateProduct(p);
	System.out.println("Update Complete. This is the new product information: \n\n"
